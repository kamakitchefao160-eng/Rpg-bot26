...
export default {
  ...
  handle: async ({ socket, remoteJid, userLid, args, mentions, sendErrorReply }) => {
    ...
    // Prioriza o nome customizado do personagem se ele tiver definido um
    const nomeP1 = p1.personagem && p1.personagem !== "Não definido (Use /nome)" ? p1.personagem : p1.nomeOficial;
    const nomeP2 = p2.personagem && p2.personagem !== "Não definido (Use /nome)" ? p2.personagem : p2.nomeOficial;
